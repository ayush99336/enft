...
export type CloseInput<
  ...
  TAccountEnft extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountEnft>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountEnft> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.enft),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountEnft>;
